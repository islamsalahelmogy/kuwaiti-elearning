    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 offset-sm-1">
                <form method="post" action="{{ route('activities.all.show.setResult',['id'=>$activity->id]) }}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="form-group form-group-icon pl-4 row">
                                    @foreach ($q->answers as $a)
                                        <div class="col-6 pl-0 pb-3">
                                            <input id="{{ $a->id }}" value="{{ $a->id }}" type="radio" class="answer-input" name="question_{{ $q->id }}" >
