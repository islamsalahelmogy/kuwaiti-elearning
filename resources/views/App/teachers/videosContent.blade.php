    ...
    <section class="py-4 list-fullwidth">
        ...
        @foreach ($videos as $video)
            <div class="media media-list-view mb-5">
                <a class="media-img" href="{{ route('teachers.videos.show',['id'=>$video->id]) }}">
            ...
            <div class="media-body">
                <h3>
                    <a class="text-warning" href="{{ route('teachers.videos.show',['id'=>$video->id]) }}">
                        {{ $video->title }}
                    </a>
                </h3>
                ...
                <div class="">
                    <a href="{{ route('teachers.videos.show',['id'=>$video->id]) }}" class="btn btn-sm btn-white text-uppercase mb-1 mr-2 btn-hover-warning w-25">
