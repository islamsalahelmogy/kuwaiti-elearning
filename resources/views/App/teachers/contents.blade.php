    ...
    <div class="d-flex justify-content-around flex-wrap">
        @if (in_array('videos',$types))   
            <a class="square my-8 mx-10" 
                href="{{ route('teachers.videos',['levelId'=>$levelId,'topicId' => $topicId , 'teacherId' => $teacherId , 'type' => 'videos']) }}">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
        ...
        @if (in_array('stories',$types))   
            <a class="square my-8 mx-10" 
                href="{{ route('teachers.stories',['levelId'=>$levelId,'topicId' => $topicId , 'teacherId' => $teacherId , 'type' => 'stories']) }}">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
