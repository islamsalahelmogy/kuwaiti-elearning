    ...
    <section class="py-4 list-fullwidth">
        ...
        @foreach ($stories as $story)
            <div class="media media-list-view mb-5">
                <a class="media-img" href="{{ route('home.stories.show',['id'=>$story->id]) }}">
            ...
            <div class="media-body">
                <h3>
                    <a class="text-warning" href="{{ route('home.stories.show',['id'=>$story->id]) }}">
                        {{ $story->title }}
                    </a>
                </h3>
                ...
                <div class="">
                    <a href="{{ route('home.stories.show',['id'=>$story->id]) }}" class="btn btn-sm btn-white text-uppercase mb-1 mr-2 btn-hover-warning w-25">
