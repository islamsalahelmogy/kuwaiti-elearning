            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-4 offset-1 offset-sm-2 offset-md-3 offset-lg-4 row">
                <div class="mb-4 mb-sm-0">
                        ...
                        <div class="border rounded-bottom-md border-top-0">
                            <div class="p-3">
                                <form action="{{ route('topic.update',['id'=> $topic->id]) }}" method="POST" role="form">
                                    @csrf
                                    ...
                                    <div class="form-group form-group-icon">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="name" 
                                                value="@error('name') {{ old('name') }} @else {{ $topic->name }} @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description')  is-invalid @enderror" id="exampleFormControlTextarea1" rows="3" 
                                            name="description">@error('description') {{ old('description') }} @else {{ $topic->description }} @enderror</textarea>
                                        @error('description')
